<template>
    <div class="information-event-container">
        <div class="event-title">
            <h2>Accident avec</h2>
            <p class="information-event-info">Cree le date a heure par personne</p>
        </div>
        <div class="event-element">
            <div class="information-event-form">
                <label for="title">Titre</label>
                <input type="text" value="Accident avec personne" id="title" name="title" />
            </div>
            ...
            <div class="information-event-form">
                ...
                <select name="employe" id="employee">
                    <option value="value">Value</option>
                </select>
            </div>
        </div>
...
<script>
    export default{
        ...
        onCreated(){
            this.event = this.$store.dispatch('getEvent', this.idEvent);
        }
    }
</script>